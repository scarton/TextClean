...
/**
 * <p>Cleanses text by applying a list of regular expressions</p>
...
public class RegexCleaner {
	 ...
	 /**
	 * <p>Loads a list of regular expressions from a classpath resource (file).
	 * Parses each into a List.</p>
	 * @throws IOException
	 */
	private void loadRegexes() throws IOException {
	 ...
	 /**
	 * <p>Cleanses lines of text. Runs each regex over the entire line and replaces each match with an empty string.</p>
	 * @param raw
	 */
